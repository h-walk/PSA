...
def parse_arguments():
    ...
    parser.add_argument('--bins_kx', type=int, default=100, help='Number of bins for kx axis in heatmaps.')
    parser.add_argument('--bins_ky', type=int, default=100, help='Number of bins for ky axis in heatmaps.')
...
def plot_heatmap(heatmap, x_edges, y_edges, w0, output_path, normalize=False, global_max=None):
    ...
    if normalize and global_max is not None:
        ...
        heatmap_scaled = np.sqrt(heatmap_normalized)
        ...
        img = plt.imshow(heatmap_safe.T, origin='lower', extent=extent, aspect='auto',
